 ...
 * lirc_bcm63xx.c
 *
 * lirc_bcm63xx - Device driver that records pulse- and pause-lengths
...
#define LIRC_DRIVER_NAME "lirc_bcm63xx"
#define RBUF_LEN 256
...
MODULE_DESCRIPTION("Infra-red receiver and blaster driver for bcm63xx.");
